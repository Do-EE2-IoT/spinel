...
GPIO_PinConfig gpioPinConfigs[31] = {
    ...
    0, /* Pin is not available on this device */
    0, /* Pin is not available on this device */
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_LOW, /* CONFIG_GPIO_PUM1 */
    ...
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_LOW, /* CONFIG_GPIO_PUM2 */
    GPIO_CFG_OUTPUT_INTERNAL | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_LOW, /* CONFIG_GPIO_PUM3 */
...
const uint_least8_t CONFIG_GPIO_PUM1_CONST = CONFIG_GPIO_PUM1;
const uint_least8_t CONFIG_GPIO_PUM2_CONST = CONFIG_GPIO_PUM2;
const uint_least8_t CONFIG_GPIO_PUM3_CONST = CONFIG_GPIO_PUM3;
